...
export class RandomDataUtil {
    ...
    static generateUpdatedProductPayload() {
        const productPayload = this.generateProductPayload();
        productPayload.title = `Updated ${productPayload.title}`;
        return productPayload;
    }
    ...
    static generateUserUpdatePayload() {
        const userPayload = this.generateUserPayload();
        userPayload.username = `updated-${userPayload.username}`;
        return userPayload;
    }
